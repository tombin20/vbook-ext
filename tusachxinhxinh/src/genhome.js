function execute(url, page) {
    ...
    if(url=='latest'){
        var doc = Http.get('https://tusachxinhxinh.online/page/'+page+'/').html()
        ...
        if(url=='a-z')
            var doc = Http.get('https://tusachxinhxinh.online/danh-sach-truyen/page/'+page+'/').html()
        if(url=='hot')
            var doc = Http.get('https://tusachxinhxinh.online/truyen-hot-nhat/').html()
        if(url=='mostview')
            var doc = Http.get('https://tusachxinhxinh.online/nhieu-xem-nhat/').html()
        else
            var doc = Http.get('https://tusachxinhxinh.online/tron-bo/').html()
